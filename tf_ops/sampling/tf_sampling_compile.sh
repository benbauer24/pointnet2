#/bin/bash
#/usr/local/cuda-11.4/bin/nvcc tf_sampling_g.cu -o tf_sampling_g.cu.o -c -O2 -DGOOGLE_CUDA=1 -x cu -Xcompiler -fPIC
...
# TF2.8
#g++ -std=c++14 tf_sampling.cpp tf_sampling_g.cu.o -o tf_sampling_so.so -shared -fPIC -I $venv/py38/lib/python3.8/site-packages/tensorflow/include -I /usr/local/cuda-11.4/include -I $venv/py38/lib/python3.8/site-packages/tensorflow/include/external/nsync/public -lcudart -L /usr/local/cuda-11.4/lib64/ -L $venv/py38/lib/python3.8/site-packages/tensorflow -fPIC -O2 -D_GLIBCXX_USE_CXX11_ABI=0
