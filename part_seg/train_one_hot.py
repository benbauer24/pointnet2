...
parser.add_argument('--model', default='pointnet2_part_seg_msg_one_hot', help='Model name [default: pointnet2_part_seg_msg_one_hot]')
...
def train_one_epoch(sess, ops, train_writer):
    ...
    num_batches = int(len(TRAIN_DATASET)/BATCH_SIZE)          #converted to int
...
def eval_one_epoch(sess, ops, test_writer):
    ...
    num_batches = int((len(TEST_DATASET)+BATCH_SIZE-1)/BATCH_SIZE)                    #Converted to int
